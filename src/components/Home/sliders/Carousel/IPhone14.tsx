  ...
  return (
    <div className="bg-black h-[274px] md:grid md:grid-cols-[45%_55%] lg:h-[324px] -mr-[30px]"> {/* -mr-[30px] due to the margin right on both .slick inside globals.css */}
      <div className="flex flex-col items-center md:items-start md:ml-10 lg:mx-auto">
        <Image src={appleLogo} alt="iPhone 14 Series" width={120} height={49} className="pt-2 mb-2 h-auto md:w-36 md:mt-7 md:mb-7 lg:w-40 xl:w-48" />
      ...
      <div className="md:mt-2">
        <Image src={phone} alt="" quality={100} width={496} height={368} className="mt-2 h-auto w-40 md:w-[31rem] mx-auto" />
      </div>
    </div>
  )
}
